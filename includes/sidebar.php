<div class="col-sm-3 col-sm-offset-1 blog-sidebar" style="margin-top:50px">
            <div class="sidebar-module">
                ...
                <form class="form-inline">
                    <div class="form-group">
                        <input type="text" name="search"  class="form-control" id="exampleInputName2" placeholder="Rechercher">
                    </div>
                </form>
          </div>
          ...
          <div class="sidebar-module">
            ...
            <ol class="list-unstyled">
              <li><a href="https://github.com/meach-kaddour">GitHub</a></li>
              <li><a href="https://twitter.com/home">Twitter</a></li>
              <li><a href="https://www.facebook.com/skoma.maache">Facebook</a></li>
            </ol>
          </div>
        </div><!-- /.blog-sidebar -->